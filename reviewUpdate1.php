...
<body>
  <div class="hero_area">
    ...
    <section>
        ...
        <form class="writeForm" action="board_process1.php?mode=update" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            <!-- 기존 코드 -->
            ...
            <div class="star-rating space-x-4 mx-auto">
                <input type="radio" id="5-stars" name="rating" value="5" <?php if ($review['rating'] == 5) echo 'checked="checked"'; ?>/>
                <label for="5-stars" class="star pr-4">★</label>
                <input type="radio" id="4-stars" name="rating" value="4" <?php if ($review['rating'] == 4) echo 'checked="checked"'; ?>/>
                <label for="4-stars" class="star">★</label>
                <input type="radio" id="3-stars" name="rating" value="3" <?php if ($review['rating'] == 3) echo 'checked="checked"'; ?>/>
                <label for="3-stars" class="star">★</label>
                <input type="radio" id="2-stars" name="rating" value="2" <?php if ($review['rating'] == 2) echo 'checked="checked"'; ?>/>
                <label for="2-stars" class="star">★</label>
                <input type="radio" id="1-star" name="rating" value="1" <?php if ($review['rating'] == 1) echo 'checked="checked"'; ?>/>
                <label for="1-star" class="star">★</label>
            </div>
            <textarea class="writeTextarea" name="story" required><?= $review['story']?></textarea>
            <!-- 이미지 업로드 부분 -->
            <?php if(!$review['image']){} else{ echo $review['image'] . "<br>"; } ?>
